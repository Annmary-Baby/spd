...
const Eventmembercompletedtask = () => {
  return (
    <View style={styles.eventmembercompletedtask}>
      <View style={styles.eventmembercompletedtaskChild} />
      <View
        style={[
          styles.eventmembercompletedtaskItem,
          styles.eventmembercompletedtaskShadowBox,
        ]}
      />
      <View
        style={[
          styles.eventmembercompletedtaskInner,
          styles.eventmembercompletedtaskShadowBox,
        ]}
      />
...
const styles = StyleSheet.create({
  eventmembercompletedtaskShadowBox: {
    height: 233,
    width: 292,
  ...
  eventmembercompletedtaskItem: {
    top: 465,
    left: 50,
  },
  eventmembercompletedtaskInner: {
    top: 193,
    left: 51,
  },
  taskNameDue: {
